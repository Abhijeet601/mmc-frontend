          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose max-w-none">
              <div className="w-full h-screen-lg">
                <iframe src={r2Url('data files/NEP 2020/Final-CO-PO_250129_145038-2.pdf')} title={i18next.t("auto.program_outcome_and_course_outcome_4hgbd3")} className="w-full h-[800px] border-2 border-gray-300 rounded-lg" />
              </div>
            </div>
          </div>
        </div>
