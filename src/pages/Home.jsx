            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                >
                  <motion.img
                    loading="lazy"
                    src={r2Url('images/Namita_singh_VC_PU.jpeg')}
              ...
              >
                {visitorCards.map((visitor, i) => (
                  ...
                  >
                    ...
                    >
                      <img
                        src={r2Url(`images/visitor-notes/${visitor.image}`)}
                        alt={visitor.name}
                        loading="lazy"
        ...
        <section className="py-10 bg-white border-t border-gray-100 relative overflow-hidden">
          ...
          <div className="px-4 text-center relative z-10">
            ...
            >
              ...
              <motion.a
                href={r2Url('documents/Handbook-2025-26 (MMC, Patna).pdf')}
                target="_blank"
                rel="noopener noreferrer"
