...
import { Building, Wrench, BookOpen, Monitor, Trophy, Cpu, ChevronDown, CheckCircle, ArrowRight, ClipboardList } from 'lucide-react';
const InfrastructureMaintenance = () => {
  ...
  const maintenanceSections = [{
    id: 'building',
    title: i18next.t("auto.building_infrastructure_1bjj0es"),
    icon: Building,
...
• Maintenance of toilets and other service areas have been outsourced through outsourcing agencies as the norms prescribed by the university administration.`
    ...
    id: 'furniture',
    title: i18next.t("auto.maintenance_of_furniture_2u8mrl"),
    icon: Wrench,
...
• The college maintains inventory of all furniture for efficient management.`
    ...
    id: 'laboratory',
    title: i18next.t("auto.maintenance_of_laboratory_equipment_1iff1bs"),
    icon: Cpu,
...
• After approval of the committee, required items have been purchased.`
    ...
    id: 'library',
    title: i18next.t("auto.maintenance_of_library_r03cge"),
    icon: BookOpen,
...
• Digital library resources are maintained and upgraded regularly.`
    ...
    id: 'sports',
    title: i18next.t("auto.maintenance_of_indoor_sports_complex_txl1sp"),
    icon: Trophy,
...
• Special maintenance is done for sports equipment and grounds.`
    ...
    id: 'digital',
    title: i18next.t("auto.maintenance_of_digital_devices_k40rgg"),
    icon: Monitor,
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          duration: 0.8
            ...
            delay: 0.2
              ...
              ${i18next.t("auto.procedures_for_maintenance_of_infrastructure_1j2799v")}
            `}</motion.p>
          </motion.div>
          ...
          delay: 0.2
            ...
            <motion.div className="flex items-center gap-3 mb-8 pb-4 border-b-2 border-primary" initial={{
            opacity: 0,
            x: -30
          }} animate={{
            opacity: 1,
            ...
            delay: 0.3
              ...
              <h2 className="text-2xl font-semibold text-primary">{`
                ${i18next.t("auto.institutional_mechanisms_for_maintenance_1lhckk2")}
              `}</h2>
            </motion.div>
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-4">
              ...
              return <motion.div key={section.id} variants={itemVariants} className="group">
                    <motion.button onClick={() => toggleSection(index)} className={`w-full text-left p-5 rounded-xl transition-all duration-300 border-2 ${isOpen ? 'bg-gradient-to-r from-primary/10 to-maroon-500/10 border-primary' : 'bg-gray-50 border-gray-200 hover:border-primary/50'}`} whileHover={{
                  scale: 1.02,
                  y: -3
                }} whileTap={{
                  scale: 0.98
            ...
            delay: 0.5
              ...
              <div>
                <h2 className="text-2xl font-bold text-primary mb-4">{`
                  ${i18next.t("auto.our_commitment_to_quality_maintenance_6nc5wl")}
                `}</h2>
                <p className="text-gray-700 text-lg leading-relaxed mb-6">{`
                  ${i18next.t("auto.magadh_mahila_college_is_committed_to_providing_19c0lqz")}
                `}</p>

                {/* Features List */}
                <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-4" variants={containerVariants} initial="hidden" animate="visible">
                  {['Transparent tender system', 'Regular inspections', 'Qualified maintenance staff', 'Modern equipment', 'Safety compliance', 'Sustainable practices'].map((feature, idx) => <motion.div key={idx} variants={itemVariants} className="flex items-center gap-3">
                      <motion.div animate={{
                    scale: [1, 1.2, 1]
                  }} transition={{
                    duration: 2,
          ...
          delay: 0.6
            ...
            <a href="/about/mis" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-semibold transition-colors group">
              <span>{i18next.t("auto.learn_more_about_mis_1qnzpni")}</span>
              <motion.span animate={{
              x: [0, 4, 0]
            }} transition={{
              duration: 1.5,
