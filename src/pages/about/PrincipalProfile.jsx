...
All the best for your new academic journey!!!`,
    name: i18next.t("auto.prof_dr_nagendra_pd_verma_1mtydi2"),
    designation: "Principal",
    college: "Magadh Mahila College"
  };
  const achievements = [{
    year: "2014",
    title: i18next.t("auto.best_college_award_1i5i27j"),
    description: i18next.t("auto.conferred_on_shiksha_diwas_by_shri_nitish_37msgn")
  }, {
    year: "2016",
    title: i18next.t("auto.excellence_institution_of_higher_education_for_girls_nfl58l"),
    description: i18next.t("auto.awarded_by_his_excellency_shri_ram_nath_1nn6fom")
  }, {
    year: "2023",
    title: i18next.t("auto.green_school_award_2u6zyj"),
    description: i18next.t("auto.declared_by_bihar_state_pollution_control_board_1m6876h")
  }];
    ...
    duration: 0.5
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        ease: "easeOut"
          ...
          <motion.div data-section="principal" className="animate-section mb-12" initial={{
          opacity: 0,
          scale: 0.95
        }} animate={visibleSections.has('principal') ? {
          opacity: 1,
          scale: 1
        } : {
          opacity: 0,
          ...
          delay: 0.3
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              stiffness: 200
                ...
                <div className="bg-gradient-to-br from-blue-100 to-maroon-100 rounded-2xl p-4 shadow-xl">
                  <div className="relative rounded-xl overflow-hidden bg-white shadow-lg">
                    <img src={r2Url('images/principal.jpg')} alt={principalMessage.name} className="w-full h-auto object-cover" style={{
                    maxHeight: '500px'
                  }} />
                    <motion.div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-6" initial={{
                    opacity: 0,
                    y: 20
                  }} animate={visibleSections.has('principal') ? {
                    opacity: 1,
                ...
                {/* Decorative elements */}
                <motion.div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-20" animate={{
                scale: [1, 1.1, 1],
                opacity: [0.2, 0.3, 0.2]
              }} transition={{
                duration: 3,
                ...
                <motion.div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-maroon-400 to-maroon-600 rounded-full opacity-20" animate={{
                scale: [1, 1.2, 1],
                opacity: [0.2, 0.4, 0.2]
              }} transition={{
                duration: 4,
              ...
              {/* Principal Message */}
              <motion.div variants={containerVariants} initial="hidden" animate={visibleSections.has('principal') ? "visible" : "hidden"} className="space-y-6">
                <motion.div variants={itemVariants}>
                  <motion.h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 flex items-center" whileHover={{
                  x: 10
                }} transition={{
                  type: "spring",
                  stiffness: 300
                ...
                <motion.div variants={itemVariants} className="bg-gradient-to-r from-blue-50 to-maroon-50 rounded-xl p-6 border-l-4 border-blue-500">
          ...
          <motion.div data-section="achievements" className="animate-section mt-16" initial={{
          opacity: 0,
          y: 30
          ...
          delay: 0.5
            ...
            <motion.h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center flex items-center justify-center" whileHover={{
            x: 10
          }} transition={{
            type: "spring",
            stiffness: 300
              ...
              ${i18next.t("auto.college_achievements_1uoqqbe")}
              `}<span className="w-2 h-8 bg-maroon-500 rounded-full ml-3"></span>
            </motion.h2>

            <div className="grid md:grid-cols-3 gap-6">
              {achievements.map((achievement, index) => <motion.div key={index} className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-blue-500 hover:shadow-xl transition-shadow duration-300" whileHover={{
              y: -10,
              ...
              delay: 0.6 + index * 0.2
                  ...
                  <motion.div className="inline-block bg-gradient-to-r from-blue-500 to-maroon-500 text-white px-4 py-1 rounded-full text-sm font-semibold mb-4" whileHover={{
                scale: 1.05
              }}>
                    {achievement.year}
                  </motion.div>
          ...
          {/* Footer Quote */}
          <motion.div data-section="quote" className="animate-section mt-16 text-center" initial={{
          opacity: 0,
          y: 30
        }} animate={visibleSections.has('quote') ? {
          opacity: 1,
          y: 0
        } : {
          opacity: 0,
          ...
          delay: 0.8
            ...
            <motion.div className="bg-gradient-to-r from-blue-500 to-maroon-500 rounded-2xl p-8 text-white" whileHover={{
            scale: 1.02
          }} transition={{
            type: "spring",
            stiffness: 200
          }}>
              <motion.p className="text-xl md:text-2xl font-semibold italic" initial={{
              opacity: 0
            }} animate={visibleSections.has('quote') ? {
              opacity: 1
            } : {
              ...
              duration: 0.8
                ...
                ${i18next.t("auto.education_is_the_most_powerful_weapon_which_1subu7m")}
              `}</motion.p>
              <motion.p className="mt-4 text-white/80" initial={{
              opacity: 0
            }} animate={visibleSections.has('quote') ? {
              opacity: 1
            } : {
              ...
              duration: 0.8
                ...
                ${i18next.t("auto.nelson_mandela_1nwq837")}
              `}</motion.p>
            </motion.div>
          </motion.div>
        </motion.div>
