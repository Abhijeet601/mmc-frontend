...
const NAACCertificates = () => {
  ...
  return <>
      <Helmet>
        <title>{i18next.t("auto.naac_certificates_accreditation_magadh_mahila_college_1nw2xy8")}</title>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            duration: 0.6
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                <span className="text-primary">{i18next.t("auto.naac_certificates_wr6rgu")}</span>
              </h1>
