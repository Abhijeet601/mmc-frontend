        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-primary">Student Feedback Form</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Your feedback is crucial for us to maintain and improve the quality of education and facilities at Magadh Mahila College.
            </p>
          </motion.div>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Teaching Quality</span>
                    <RatingStars
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Course Content</span>
                    <RatingStars
                      field="courseContent"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Library Services</span>
                    <RatingStars
                      field="library"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Laboratory Facilities</span>
                    <RatingStars
                      field="laboratory"
