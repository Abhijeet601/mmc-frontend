        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-primary">Alumni Feedback Form</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Your experience and insights as an alumnus are invaluable in helping us shape the future of education at Magadh Mahila College.
            </p>
          </motion.div>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Relevance of Curriculum to Industry</span>
                    <RatingStars
                      field="relevance"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Skills Development</span>
                    <RatingStars
                      field="skills"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Networking Opportunities</span>
                    <RatingStars
                      field="networking"
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Placement & Career Support</span>
                    <RatingStars
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Overall College Experience</span>
                    <RatingStars
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-section rounded-lg">
                    <span className="font-medium text-foreground mb-2 md:mb-0">Career Readiness</span>
                    <RatingStars
                      field="careerReadiness"
