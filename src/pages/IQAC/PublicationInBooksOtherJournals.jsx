...
const PublicationInBooksOtherJournals = () => {
  ...
  const pdfFiles = [{
    ...
    description: i18next.t("auto.comprehensive_collection_of_publications_in_books_and_wt4zrw")
  }, {
    ...
    description: i18next.t("auto.research_publications_by_mmc_faculty_members_in_y7rluc")
  }];
  return <>
      <Helmet>
        <title>{i18next.t("auto.publication_in_books_other_journals_iqac_magadh_7ffci")}</title>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            duration: 0.6
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                <span className="text-primary">{i18next.t("auto.publication_in_books_other_journals_1fatbo")}</span>
              </h1>
              <p className="text-foreground max-w-3xl mx-auto text-lg">{`
                ${i18next.t("auto.explore_our_collection_of_publications_in_books_1hewcnr")}
              `}</p>
            </motion.div>
            ...
            duration: 0.6
              ...
              <h2 className="text-3xl font-bold mb-4">{i18next.t("auto.publications_support_474zut")}</h2>
              <p className="text-white/90 mb-8 max-w-2xl mx-auto">{`
                ${i18next.t("auto.for_publication_submissions_or_access_to_our_7fb16r")}
              `}</p>
