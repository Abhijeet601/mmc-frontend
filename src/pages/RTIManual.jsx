  ...
  return <>
      ...
      <div className="pt-0 min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold text-primary mb-8">{i18next.t("auto.rti_manual_18411dc")}</h1>
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <p className="text-gray-600">{i18next.t("auto.rti_manual_content_will_be_added_here_ajdous")}</p>
          </div>
        </div>
      </div>
    </>;
