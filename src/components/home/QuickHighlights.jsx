...
import { BookOpen, Building2, Users, Trophy } from 'lucide-react';
...
const QuickHighlights = () => {
  ...
  const highlights = [
    ...
    {
      icon: Users,
      title: t('quickHighlights.admissionsOpen'),
      description: t('quickHighlights.admissionsOpenDesc'),
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((highlight, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative h-full p-8 rounded-xl bg-white shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200">
                <motion.div
